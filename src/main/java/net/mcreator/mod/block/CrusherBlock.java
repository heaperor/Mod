...
import net.mcreator.mod.gui.CrusherGuiGui;
...
public class CrusherBlock extends ModModElements.ModElement {
	@ObjectHolder("mod:crusher")
	public static final Block block = null;
	public CrusherBlock(ModModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(1D, 0D, 1D, -2D, 3D, -2D);
				case NORTH :
					return VoxelShapes.create(0D, 0D, 0D, 3D, 3D, 3D);
				case WEST :
					return VoxelShapes.create(0D, 0D, 1D, 3D, 3D, -2D);
				case EAST :
					return VoxelShapes.create(1D, 0D, 0D, -2D, 3D, 3D);
			}
		}
