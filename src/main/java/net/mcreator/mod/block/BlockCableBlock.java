...
public class BlockCableBlock extends ModModElements.ModElement {
	@ObjectHolder("mod:block_cable")
	public static final Block block = null;
	public BlockCableBlock(ModModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			return VoxelShapes.create(0.5D, 0.5D, 0.5D, 0.5D, 0.5D, 0.5D);
		}
